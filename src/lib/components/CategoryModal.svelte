        ...
        <div class="flex flex-col gap-2 max-h-60 overflow-y-auto pr-2">
          {#each tempCategories as cat, i}
            <div class="flex items-center gap-2">
              ...
              <button type="button" aria-label="Delete Category" class="p-1.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors" onclick={() => removeCategory(i)}>
